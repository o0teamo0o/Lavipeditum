...
/**
 * 
 * @ClassName: DirectionalViewPager 
 * @Description: 自定义ViewPager 能让ViewPager和ScrollView嵌套使用

 * @author o0teamo0o
 * @date 2014年11月17日 下午5:45:58 
 *
 */
public class DirectionalViewPager extends ViewPager {
	...
	/**
	 * 
	 * Title: setPagingEnabled
	 * Description: 设置页面是否支持滑动
	 * @param enabled
	 */
